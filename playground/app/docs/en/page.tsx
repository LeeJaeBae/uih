            ...
            <div className="max-w-4xl mx-auto">
              <section className="mb-16 text-center">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                  {"Unified UI Meta Language for React, Vue, and Svelte"}
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      {
                        "Supports all Tailwind utility classes and CSS variables."
                      }
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      {"Compile to React, Vue, and Svelte simultaneously."}
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    <div className="text-4xl mb-4">{"⚡"}</div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      {"Auto-generates state, validation, and API logic."}
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    <div className="text-4xl mb-4">{"🤖"}</div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      {
                        "Integrated with Claude Code for natural language UI generation."
                      }
                    </p>
                  </div>
                </div>
